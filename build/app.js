...
app.get('/online-users', function (req, res) {
    res.send({ onlineUsers: shared_1.shared.onlineUsers });
});
app.get('/chat/:room', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var room;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, model_1.RoomModel.findOne({ name: req.params.room })];
            case 1:
                room = _a.sent();
                if (!room) {
                    res.status(404).send();
